...
class DescribeStaminaPoolRequest(Gs2BasicRequest):

    class Constant(Gs2Stamina):
        FUNCTION = "DescribeStaminaPool"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeStaminaPoolRequest, self).__init__(params)
        if params is None:
    ...
    def with_page_token(self, page_token):
        ...
        :type page_token: unicode
        :return: this
        :rtype: DescribeStaminaPoolRequest
        """
