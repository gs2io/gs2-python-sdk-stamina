...
class GetStaminaPoolStatusRequest(Gs2BasicRequest):

    class Constant(Gs2Stamina):
        FUNCTION = "GetStaminaPoolStatus"
    ...
    def __init__(self, params=None):
        ...
        """
        super(GetStaminaPoolStatusRequest, self).__init__(params)
        if params is None:
    ...
    def with_stamina_pool_name(self, stamina_pool_name):
        ...
        :type stamina_pool_name: unicode
        :return: this
        :rtype: GetStaminaPoolStatusRequest
        """
